...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_game_js__ = __webpack_require__(7);
...
class State  {
  constructor() {
    ...
    this.game = new __WEBPACK_IMPORTED_MODULE_1__src_game_js__["a" /* default */]();
    this._pause = false;
...
const board = {
  ...
  view: () => {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.board', {
      style: {
      ...
      return line.map((cell) => __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.cell',{
...
const log = {
  view: () => {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('.log', state.game.fitness)
  }
}
...
__WEBPACK_IMPORTED_MODULE_0_mithril___default.a.mount(playground, board);
__WEBPACK_IMPORTED_MODULE_0_mithril___default.a.mount(logs, log);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__board__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_constants__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_constants___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_constants__);
...
class Game {
  ...
  constructor () {
    this.board = new __WEBPACK_IMPORTED_MODULE_0__board__["a" /* default */](30, brain1);
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__snake_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_js__ = __webpack_require__(6);
...
class Board  {
  ...
  constructor(size, brain) {
    ...
    this.snake = new __WEBPACK_IMPORTED_MODULE_0__snake_js__["a" /* default */](10, this, brain);
    this.addCherry();
  ...
  randomCell() {
    ...
    return new __WEBPACK_IMPORTED_MODULE_1__cell_js__["a" /* default */](randomVal(), randomVal());
  }
...
class Snake {
  ...
  move() {
    ...
    const newHead = new __WEBPACK_IMPORTED_MODULE_0__cell__["a" /* default */](this.head.x + x, this.head.y + y)
  ...
  init(length) {
    ...
    const head = new __WEBPACK_IMPORTED_MODULE_0__cell__["a" /* default */](startx, starty); 
    this._body.push(head);
    while(this._body.length < length) {
      startx +=1;
      const cell = new __WEBPACK_IMPORTED_MODULE_0__cell__["a" /* default */](startx, starty);
